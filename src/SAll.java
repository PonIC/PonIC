 ...
 *
 */
public class SAll implements PlanAssembler {
	...
	public static class GroupReducer extends ReduceStub{
		...
		public void reduce(Iterator<PactRecord> iter, Collector<PactRecord> collector)
			...
			while(iter.hasNext()){
				rec = iter.next();
				str = str + " " + rec.getField(0, PactString.class).toString();
				str = str + " " + rec.getField(1, PactString.class).toString();
			}
	...
	public Plan getPlan(String... args) {
		...
		ReduceContract group = ReduceContract.builder(GroupReducer.class, PactString.class, 0)
				.input(join)
				.name("group")
				.build();
