...
/**
 * 
 * Copy of FileInputFormat with the only difference that the methods
 * readRecord() and nextRecord() have Tuple as targets instead of PactRecord
 * @author hinata
 *
 */
public abstract class SPigFileInputFormat implements InputFormat<Tuple, FileInputSplit> {

	/**
	 * The log.
	 */
	private static final Log LOG = LogFactory.getLog(SPigFileInputFormat.class);
	...
	public void configure(Configuration parameters)
	{
		...
		if (filePath == null) {
			throw new IllegalArgumentException("Configuration file SPigFileInputFormat does not contain the file path.");
		}
