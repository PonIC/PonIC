...
import org.apache.pig.SStoreFuncInterface;	//AVK
import org.apache.pig.backend.executionengine.ExecException;
import org.apache.pig.backend.hadoop.datastorage.ConfigurationUtil;
import org.apache.pig.builtin.PigStorage;
import org.apache.pig.builtin.SPigStorage;	//AVK
...
public class LogicalPlanBuilder {
    ...
    throws IOException, URISyntaxException {
        if( funcSpec == null ){
        	...
        	if(pigContext.getExecType() == ExecType.STRATO){
        		funcSpec = new FuncSpec( SPigStorage.class.getName() );
        	}
        	else{
        ...
        //AVK
        if(pigContext.getExecType() == ExecType.STRATO){
            SLoadFunc loFunc = (SLoadFunc)PigContext.instantiateFuncFromSpec( funcSpec );
    ...
    throws IOException, URISyntaxException {
        ...
        //AVK
        if(pigContext.getExecType() == ExecType.STRATO){
            SStoreFuncInterface stoFunc = (SStoreFuncInterface)obj;
