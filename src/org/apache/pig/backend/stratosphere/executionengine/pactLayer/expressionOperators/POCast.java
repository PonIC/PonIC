...
public class POCast extends ExpressionOperator {
    ...
    private void instantiateFunc() throws IOException {
        ...
        if (funcSpec != null) {
            ...
            if (obj instanceof SLoadFunc) {
                caster = ((SLoadFunc)obj).getLoadCaster();
    ...
    public Result getNext(Boolean b) throws ExecException {
        PactOperator in = inputs.get(0);
        Byte resultType = in.getResultType();
        switch (resultType) {
        case DataType.BAG: {
            Result res = new Result();
            res.returnStatus = SOStatus.STATUS_ERR;
            return res;
        }
        ...
        case DataType.BYTEARRAY: {
            ...
            if (res.returnStatus == SOStatus.STATUS_OK && res.result != null) {
                try {
