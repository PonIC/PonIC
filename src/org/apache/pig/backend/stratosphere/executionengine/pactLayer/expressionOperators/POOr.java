...
public class POOr extends BinaryComparisonOperator {
    ...
    public Result getNext(Boolean b) throws ExecException {
        ...
        if(left.returnStatus != SOStatus.STATUS_OK && left.returnStatus != SOStatus.STATUS_NULL) {
            return left;
        }
        ...
        // pass on ERROR and EOP 
        if(right.returnStatus != SOStatus.STATUS_OK && right.returnStatus != SOStatus.STATUS_NULL) {
            return right;
        }
