...
public abstract class ExpressionOperator extends PactOperator {
    ...
    @Override
    public abstract void visit(PactPlanVisitor v) throws VisitorException;
            ...
            if (child != null) {
                for(ExpressionOperator e: child) {
                    if (e.containUDF()) {
                        ...
                        if (res.returnStatus != SOStatus.STATUS_BATCH_OK) {
                            return res;
                        }
                    }
                }
