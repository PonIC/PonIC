...
public class LOStore extends LogicalRelationalOperator {
 ...
 // If we know how to reload the store, here's how. The lFile
    ...
    transient private SStoreFuncInterface storeFunc;
    //transient private SStoreFuncInterface sstoreFunc;
    ...
    public LOStore(LogicalPlan plan, FileSpec outputFileSpec) {
        ...
        //AVK 
        //sstoreFunc = (SStoreFuncInterface) PigContext.instantiateFuncFromSpec(outputFileSpec.getFuncSpec());
        storeFunc = (SStoreFuncInterface) PigContext.instantiateFuncFromSpec(outputFileSpec.getFuncSpec()); 
    }
    ...
    /*public SStoreFuncInterface getSStoreFunc() {
        return sstoreFunc;
    }*/
